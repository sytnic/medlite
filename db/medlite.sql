...
CREATE TABLE `client_requests` (
  ...
  `client_edited` tinyint(1) NOT NULL,
  `docadmin_edited` int(10) DEFAULT NULL,
  `when_edited` timestamp NOT NULL,
  PRIMARY KEY (`id`),
  KEY `doc_id` (`doc_id`),
  KEY `spec_id` (`spec_id`),
  KEY `docadmin_edited` (`docadmin_edited`),
  CONSTRAINT `client_requests_ibfk_2` FOREIGN KEY (`doc_id`) REFERENCES `docs` (`id`),
  CONSTRAINT `client_requests_ibfk_3` FOREIGN KEY (`spec_id`) REFERENCES `specs` (`id`),
  CONSTRAINT `client_requests_ibfk_5` FOREIGN KEY (`docadmin_edited`) REFERENCES `docadmins` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
