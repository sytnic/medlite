<?php require_once("../includes/session.php");
      ...
      // и обрабатывает данные по алфавиту, по буквам,
      // пришедшие из БД.
?>
<?php
...
?>        
    ...
    <?php   // Display specialties alphabetically
            ...
            // 0. Несортированный массив из БД
            var_dump($specs);
            echo "<hr>";

            // 1.1. Сортированный массив из БД
            sort($specs);
            ...
            // 2. 3.
            // Выяснение первой буквы каждого значения в массиве из БД.
            // Добавление значения в соответствующее место в алфавитном массиве.
                ...
                if (!empty($value)) {
                    ...
                    */
                    ...
                    foreach ($value as $meaning) { 
                        $output = '<a href="choice_doc.html?spec='.$meaning.'" class="w3-button w3-border">';
                        $output.= $meaning;
                        $output.= '</a>'."\r\n";
                        echo $output;
                    }
